...
/***/ function(module, exports, __webpack_require__) {
	...
	var _app_ui = __webpack_require__(1);
	
	var _app_ui2 = _interopRequireDefault(_app_ui);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	new _app_ui2.default().render('div');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _app_ui = __webpack_require__(4);
	
	var _app_ui2 = _interopRequireDefault(_app_ui);
	
	var _material_card_template = __webpack_require__(5);
	
	var _material_card_template2 = _interopRequireDefault(_material_card_template);
	
	var _building = __webpack_require__(6);
	...
	var AppUI = function () {
	    ...
	    _createClass(AppUI, [{
	        key: 'initialize_building',
	        value: function initialize_building(event) {
	            event.preventDefault();
	            try {
	                var no_of_floors = parseInt((0, _jquery2.default)('#no-of-floors').val());
	                if (no_of_floors > 200) {
	        ...
	        key: 'go_to_floor',
	        value: function go_to_floor(event) {
	            event.preventDefault();
	            var floor_to_go = parseInt((0, _jquery2.default)('#sel-available-floors').val());
	        ...
	        key: 'create_building',
	        value: function create_building(no_of_floors) {
	            this._building = new _building2.default(no_of_floors);
	            this.update_floor_selector();
	            (0, _jquery2.default)('#status-window').html(''); // empty messages
	            this.update_status_windows('New building with ' + no_of_floors + ' has been created');
	        }
	    }, {
	        key: 'update_floor_selector',
	        value: function update_floor_selector() {
	            // removes all options before adding new ones
	            (0, _jquery2.default)('#sel-available-floors').find('option').remove().end();
	
	            for (var i = 0; i < this._building.get_number_of_floors(); i++) {
	                (0, _jquery2.default)('#sel-available-floors').append((0, _jquery2.default)("<option></option>").attr("value", i).text('Floor ' + i));
	            }
	        }
	    }, {
	        key: 'update_status_windows',
	        value: function update_status_windows(message) {
	            var text = message;
	            (0, _jquery2.default)('#status-window').prepend(_mustache2.default.render(_material_card_template2.default, { text: text }));
	        }
	    }, {
	        key: 'render',
	        value: function render(node) {
	            ...
	            (0, _jquery2.default)(node).html(_mustache2.default.render(_app_ui2.default, { text: text }));
	
	            // Attach our listeners
	            (0, _jquery2.default)('#btn-initialize-building').click(this.initialize_building.bind(this));
	            (0, _jquery2.default)('#btn-go-to-floor').click(this.go_to_floor.bind(this));
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"container\">\r\n    \r\n    <div class=\"row\">\r\n        <div class=\"col s12 ilike-blue-container\">\r\n            <h3>Welcome to the Elevator Demo.</h1>\r\n            <blockquote>Press F12 on your browser to see the console messages.</blockquote>\r\n        </div>        \r\n    </div>\r\n    <div class=\"row\">\r\n        <div class=\"col s6\">\r\n            <input type=\"text\" id=\"no-of-floors\" placeholder=\"Enter storeys for your building\">\r\n        </div>\r\n        <div class=\"col s6\">\r\n            <button id=\"btn-initialize-building\">Initialize</button>\r\n        </div>\r\n    </div>\r\n    <div class=\"row\">\r\n        <div class=\"col s3\">           \r\n            <select id=\"sel-available-floors\">\r\n            </select>\r\n        </div>\r\n        <div class=\"col s3\">\r\n            <button id=\"btn-go-to-floor\">Go to Floor</button>\r\n        </div>\r\n    </div>\r\n    <div class=\"card-panel\" id=\"status-window\"></div>\r\n</div>";
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"card-panel\"><b>{{text}}</b></div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _elevator = __webpack_require__(8);
	...
	var Building = function () {
	    function Building(number_of_floors) {
	        ...
	        console.log('Creating new building with ' + number_of_floors + ' floors');
	    ...
	    _createClass(Building, [{
	        ...
	        key: 'get_elevator_current_direction',
	        value: function get_elevator_current_direction() {
	            return this._elevator.get_direction();
	        }
	    }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _door = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
		// When the styles change, update the <style> tags
		if (!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./app_ui.scss", function () {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./app_ui.scss");
				if (typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ilike-blue-container {\n  background: #97a3bf; }\n\nselect {\n  display: block; }\n", ""]);
